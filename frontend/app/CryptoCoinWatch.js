...
var CryptoCoinWatch = {
    ...
    cmdWatch: "0x7761746368",

    contractAddress: "0x987c1f13d417f7e04d852b44badc883e4e9782e1",

    addressOffset: bigInt(2).pow(160),

    addressRecordSize: bigInt(4),

    getStatistics: function(contract) {
        return {
    ...
    getWatchList: function(contract) {
        var result = [];
    ...
    watchAddress: function(contract, address) {
        var hex;
        try {
...
module.exports = CryptoCoinWatch;
